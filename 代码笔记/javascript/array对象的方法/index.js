...
// array.flat(depth)
// 此方法可将数组扁平化，即将一个多维数组转为一维数组
// 参数 depth 可选，代表扁平的深度，默认值是 1
// 可用 Inifinity 代表最深遍历
// 返回一个扁平后的新数组
var a16 = [1, 2, [3, [4, 5]]];
console.log(a16.flat()); // [1, 2, 3, [4, 5]]
console.log(a16.flat(2)); // [1, 2, 3, 4, 5]
console.log(a16.flat(Infinity)); // [1, 2, 3, 4, 5]
